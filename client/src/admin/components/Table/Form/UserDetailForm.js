...
export const UserDetailForm = (props) => {
  ...
  const onRefreshPwHandler = ()=> {
    setNewPassword(`VLU${account.username.slice(-5)}`)
  }
    ...
    <>
      <div className="flex flex-col space-y-8 items-center bg-white px-14 py-4 rounded-lg mx-auto z-10">
        ...
        <div className="flex space-x-8 text-sm items-center">
          ...
          <input
            type="text"
            className={`py-2 px-4 border rounded-lg outline-gray-300 w-80 ${classes.disabled}`}
            disabled
        ...
        <div className="flex space-x-8 text-sm items-center">
          ...
          <div className="w-80 flex items-center space-x-2">
            <input
              type="text"
              className="py-2 px-4 border rounded-lg outline-gray-300 w-11/12"
              disabled
              value={newPassword}
            />
            <svg
        ...
        <div className="flex space-x-8 text-sm items-center">
          ...
          <input
            type="text"
            className="py-2 px-4 border rounded-lg outline-gray-300 w-80"
          />
        </div>
        <div className="flex space-x-8 text-sm items-center">
          ...
          <input
            type="text"
            className="py-2 px-4 border rounded-lg outline-gray-300 w-80"
            defaultValue={account.role_name}
          />
        </div>
        <div className="flex flex-col text-sm space-y-2 w-96">
          <input
            type="text"
            className="py-2 px-4 border rounded-lg outline-red-300 w-full"
          />
          <span className="text-red-400 font-medium w-full">Nhập 'XÁC NHẬN' nếu muốn thay đổi thông tin tài khoản</span>
        </div>
